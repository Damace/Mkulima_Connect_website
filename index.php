        ...
        <div class="header">
            ...
            <div class="container">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col logo_section">
                       ...
                       <div class="row">
                            <div class="col-md-12 ">
                                <div class="menu-area">
                                    <div class="limit-box">
                                        <nav class="main-menu navbar-left">
              ...
              <ul class="dropdown-menu mega-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="#">Farming input Companies</a>
                <a class="dropdown-item" href="#">Financial Institutions</a>
                <a class="dropdown-item" href="#">Insurance Companies</a>
                <a class="dropdown-item" href="#">Transportation Companies</a>
                <a class="dropdown-item" href="#">Social Security Companies</a>
              ...
              <ul class="dropdown-menu mega-menu" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item" href="#">Digital farming</a>
                <a class="dropdown-item" href="#">Crops Prices</a>
                <a class="dropdown-item" href="#"><b>TMA</b> &nbsp Updates</a>
                <a class="dropdown-item" href="#"><b>TENDER</b> &nbsp Updates</a>
                <a class="dropdown-item" href="#">Mkonekt &nbsp <b>APP</b></a>
              </ul>
            </li>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="container">
                        <div class="carousel-caption relative">
                            <h1>Karibu</h1>
                            <span>Mkulima Connect</span>

                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi </p>
                            <a class="buynow" href="#about">Nunua</a><a class="buynow ggg" href="#">Uza</a>
        ...
        <div class="container">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="title">
                            <h2>Mkonekt <strong class="black"> products</strong></h2>
                        </div>
                    </div>
                </div>
            </div>
